...
/**
 * ClassName:OperatorSinh <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2018年10月16日 下午3:14:34 <br/>
 * @author   liupingan
 * @version  
 * @since    JDK 1.8
 * @see 	 
 */
public class OperatorSinh extends OperatorBase
{

	/**
	 * @since JDK 1.8
	 */
	private static final long serialVersionUID = 582842122868334552L;

	public OperatorSinh(String aName)
	{
		this.name = aName;
	}

	public OperatorSinh(String aAliasName, String aName, String aErrorInfo)
	{
		this.name = aName;
