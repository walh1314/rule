...
/**
 * ClassName:OperatorTanh <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2018年10月16日 下午3:15:04 <br/>
 * @author   liupingan
 * @version  
 * @since    JDK 1.8
 * @see 	 
 */
public class OperatorTanh extends OperatorBase
{
	/**
	 * @since JDK 1.8
	 */
	private static final long serialVersionUID = -837784779966841790L;

	public OperatorTanh(String aName)
	{
		this.name = aName;
	}

	public OperatorTanh(String aAliasName, String aName, String aErrorInfo)
	{
		this.name = aName;
