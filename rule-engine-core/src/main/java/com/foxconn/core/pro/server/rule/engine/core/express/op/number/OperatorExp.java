...
/**
 * ClassName:OperatorExp <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2018年10月16日 下午1:49:02 <br/>
 * @author   liupingan
 * @version  
 * @since    JDK 1.8
 * @see 	 
 */
public class OperatorExp extends OperatorBase
{
	 ...
	 * @since JDK 1.8
	 */
	private static final long serialVersionUID = 5478310696643254478L;

	public OperatorExp(String aName)
	{
		this.name = aName;
	}

	public OperatorExp(String aAliasName, String aName, String aErrorInfo)
	{
		this.name = aName;
