...
/**
 * ClassName:OperatorTan <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2018年10月16日 下午3:14:51 <br/>
 * @author   liupingan
 * @version  
 * @since    JDK 1.8
 * @see 	 
 */
public class OperatorTan extends OperatorBase
{
	 ...
	 * @since JDK 1.8
	 */
	private static final long serialVersionUID = -1297161589795328459L;

	public OperatorTan(String aName)
	{
		this.name = aName;
	}

	public OperatorTan(String aAliasName, String aName, String aErrorInfo)
	{
		this.name = aName;
